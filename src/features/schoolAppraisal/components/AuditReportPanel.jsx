...
const styles = {
  ...
  generatedDate: { color: "var(--muted)", fontSize: 11 },
  section: {
    padding: 18,
    border: "1px solid #dbe3ef",
    borderRadius: 14,
  ...
  sectionHeading: { display: "flex", alignItems: "center", gap: 10, marginBottom: 14, paddingBottom: 12, borderBottom: "1px solid var(--border)" },
  sectionNumber: { width: 34, height: 34, display: "grid", placeItems: "center", flex: "0 0 34px", borderRadius: 9, color: "var(--card)", background: "var(--primary)", fontSize: 11, fontWeight: 800 },
  sectionTitle: {
    margin: 0,
    color: "var(--ink)",
    fontSize: 18,
  ...
  detailHeading: { padding: "9px 12px", border: "1px solid var(--border-strong)", color: "#1e3a8a", background: "var(--accent-soft)", fontSize: 12, textAlign: "left" },
  detailLabel: { width: "36%", padding: "9px 12px", border: "1px solid #dbe3ef", color: "#475569", background: "var(--bg)", fontSize: 11, fontWeight: 700, textAlign: "left", verticalAlign: "top" },
  detailValue: { padding: "9px 12px", border: "1px solid #dbe3ef", color: "var(--ink)", background: "var(--card)", fontSize: 11.5, whiteSpace: "pre-wrap", verticalAlign: "top" },
  auditorReportGrid: {
    display: "grid",
  ...
  auditorReportTitle: { margin: 0, color: "var(--ink)", fontSize: 13.5, fontWeight: 900 },
  auditorReportMeta: { margin: "3px 0 0", color: "var(--muted)", fontSize: 11.5, fontWeight: 700 },
  auditorReportChips: {
    display: "flex",
  ...
  signatureTitle: { gridColumn: "1 / -1", margin: 0, color: "var(--ink)", fontSize: 16 },
  signatureBlock: {
    display: "flex",
    flexDirection: "column",
    gap: 10,
  ...
  signerTitle: { margin: "0 0 12px", color: "var(--ink)", fontSize: 14 },
  iqacReviewSection: {
    breakBefore: "page",
  ...
  pendingApproval: { padding: "18px 0", color: "var(--muted)", fontSize: 13, fontWeight: 700 },
  signatureRow: {
    display: "grid",
