  ...
  return (
    <details style={styles.multiSelect}>
      ...
      <div style={styles.multiSelectMenu}>
        {schools.length === 0 ? (
          <div style={{ padding: "10px 14px", color: "var(--muted)", fontSize: "var(--text-base)" }}>
...
const styles = {
  ...
  headingRow: { display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 18, padding: 20, border: "1px solid var(--border)", borderRadius: 16, background: "var(--card)", boxShadow: "0 12px 35px rgba(15,23,42,.045)" },
  headingActions: { display: "flex", flexDirection: "row-reverse", alignItems: "center", justifyContent: "flex-start", gap: 10, flexWrap: "wrap" },
  kicker: { margin: "0 0 5px", color: "var(--primary)", fontSize: 10, fontWeight: 750, letterSpacing: ".08em", textTransform: "uppercase" },
  title: { margin: "0 0 5px", color: "var(--ink)", fontSize: 20, fontWeight: 700 },
  description: { margin: 0, color: "var(--muted)", fontSize: 12.5 },
  formCard: { display: "flex", flexDirection: "column", gap: 18, padding: 20, border: "1px solid var(--border)", borderRadius: 16, background: "var(--card)", boxShadow: "0 12px 35px rgba(15,23,42,.045)" },
  ...
  formTitle: { margin: 0, color: "var(--ink)", fontSize: 17, fontWeight: 700 },
  formHint: { color: "var(--muted)", fontSize: 11 },
  ...
  sectionTitle: { margin: 0, color: "var(--ink)", fontSize: 13, fontWeight: 800 },
  sectionHint: { color: "var(--muted)", fontSize: 11.5 },
  ...
  control: { width: "100%", minHeight: 42, border: "1px solid #d7dee9", borderRadius: 8, padding: "9px 11px", color: "var(--ink)", background: "#fbfcfe", outline: "none" },
  multiSelect: { position: "relative", width: "100%" },
  multiSelectSummary: { minHeight: 42, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10, padding: "9px 11px", border: "1px solid #d7dee9", borderRadius: 8, color: "var(--ink)", background: "#fbfcfe", fontSize: 13, cursor: "pointer", listStyle: "none" },
  multiSelectMenu: { display: "grid", gap: 4, marginTop: 6, padding: 7, border: "1px solid #d7dee9", borderRadius: 8, background: "var(--card)", boxShadow: "0 12px 28px rgba(15,23,42,.12)" },
  multiSelectOption: { minHeight: 38, display: "flex", alignItems: "center", gap: 9, padding: "7px 9px", borderRadius: 6, color: "#334155", background: "var(--bg)", fontSize: 12.5, cursor: "pointer" },
  multiSelectCheckbox: { width: 16, height: 16, accentColor: "var(--primary)", flex: "0 0 auto" },
  selectedPostList: { display: "flex", flexWrap: "wrap", gap: 5, marginTop: 6, color: "var(--primary-dark)", fontSize: 10.5, fontWeight: 700 },
  errorText: { color: "var(--red-700)", fontSize: 11, fontWeight: 650 },
  formActions: { display: "flex", justifyContent: "flex-end", gap: 10, paddingTop: 2 },
  successNotice: { padding: "10px 12px", border: "1px solid var(--green-200)", borderRadius: 10, color: "var(--green-700)", background: "var(--green-50)", fontSize: 12, fontWeight: 700 },
  errorNotice: { padding: "10px 12px", border: "1px solid var(--red-200)", borderRadius: 10, color: "var(--red-800)", background: "var(--red-50)", fontSize: 12, fontWeight: 700 },
  ...
  tableCard: { overflow: "hidden", border: "1px solid var(--border)", borderRadius: 16, background: "var(--card)", boxShadow: "0 12px 35px rgba(15,23,42,.045)" },
  ...
  tableSubtext: { margin: "5px 0 0", color: "var(--muted)", fontSize: 11.5 },
  tableBadges: { display: "flex", alignItems: "center", justifyContent: "flex-end", gap: 8, flexWrap: "wrap" },
  count: { padding: "5px 8px", borderRadius: 999, color: "#475569", background: "var(--bg-alt)", fontSize: 10.5, fontWeight: 700 },
  printHint: { padding: "5px 8px", borderRadius: 999, color: "var(--primary-dark)", background: "var(--accent-soft)", fontSize: 10.5, fontWeight: 750 },
  filterBar: { display: "grid", gridTemplateColumns: "minmax(180px, 240px) minmax(180px, 240px) auto", alignItems: "end", justifyContent: "start", gap: 12, padding: "14px 20px", borderBottom: "1px solid #edf1f6", background: "var(--bg)" },
  filterField: { display: "flex", flexDirection: "column", gap: 6 },
  filterControl: { width: "100%", minHeight: 40, border: "1px solid #d7dee9", borderRadius: 8, padding: "8px 10px", color: "var(--ink)", background: "var(--card)", outline: "none" },
  readOnlyHint: { color: "var(--muted)", fontSize: 11, fontStyle: "italic" },
  scroller: { overflowX: "auto" },
  table: { width: "100%", borderCollapse: "collapse", tableLayout: "fixed" },
  th: { padding: "10px 11px", borderRight: "1px solid var(--border)", color: "#1e293b", background: "var(--bg)", fontSize: 11.5, fontWeight: 700, textAlign: "left" },
  ...
  tableAvatarInitials: { color: "var(--card)", background: "linear-gradient(135deg, var(--primary), #3b82f6)" },
  tableAvatarPhoto: { background: "var(--bg-alt)" },
  ...
  avatarPreviewCard: { width: "min(360px, 92vw)", display: "flex", flexDirection: "column", alignItems: "center", gap: 14, padding: "28px 24px", borderRadius: 20, background: "var(--card)", boxShadow: "0 28px 80px rgba(15,23,42,.3)" },
  avatarPreviewImg: { width: 220, height: 220, borderRadius: "50%", objectFit: "cover", boxShadow: "0 0 0 4px var(--accent-soft)" },
  avatarPreviewFallback: { width: 220, height: 220, display: "grid", placeItems: "center", borderRadius: "50%", color: "var(--card)", background: "linear-gradient(135deg, var(--primary), #3b82f6)", fontSize: 64, fontWeight: 800, boxShadow: "0 0 0 4px var(--accent-soft)" },
  avatarPreviewName: { margin: 0, color: "var(--ink)", fontSize: 16, fontWeight: 800, textAlign: "center" },
  avatarPreviewMeta: { margin: 0, color: "var(--muted)", fontSize: 12.5, textAlign: "center" },
  avatarPreviewNoPhoto: { margin: 0, color: "var(--muted)", fontSize: 11.5, textAlign: "center", fontStyle: "italic" },
  avatarPreviewClose: { marginTop: 6, border: "none", borderRadius: 8, background: "var(--bg-alt)", color: "#475569", padding: "10px 22px", fontWeight: 800, cursor: "pointer", fontFamily: "inherit" },
  centerCell: { textAlign: "center", verticalAlign: "middle" },
  actionCell: { width: 96, textAlign: "center" },
  emptyCell: { padding: 28, color: "var(--muted)", fontSize: 12, textAlign: "center" },
  categoryPill: { textTransform: "capitalize", color: "var(--primary-dark)", fontWeight: 700 },
  ...
  actionGroup: { display: "inline-flex", alignItems: "center", justifyContent: "center", gap: 0, padding: 3, border: "1px solid #dbe4f0", borderRadius: 12, background: "var(--bg)", boxShadow: "inset 0 1px 0 rgba(255,255,255,.9)" },
  editButton: { width: 34, height: 32, display: "grid", placeItems: "center", border: 0, borderRight: "1px solid var(--border)", borderRadius: "9px 0 0 9px", color: "var(--primary)", background: "transparent", cursor: "pointer", fontFamily: "inherit" },
  singleActionButton: { width: 34, height: 32, display: "grid", placeItems: "center", border: 0, borderRadius: 9, color: "var(--primary)", background: "transparent", cursor: "pointer", fontFamily: "inherit" },
  ...
  deleteButton: { width: 34, height: 32, display: "grid", placeItems: "center", border: 0, borderRadius: "0 9px 9px 0", color: "var(--red-600)", background: "transparent", cursor: "pointer", fontFamily: "inherit" },
  ...
  modalCard: { width: "min(460px, 100%)", display: "grid", gridTemplateColumns: "48px 1fr", gap: 15, padding: 22, borderRadius: 22, border: "1px solid var(--red-100)", background: "linear-gradient(180deg, var(--card) 0%, #fffafa 100%)", boxShadow: "0 28px 80px rgba(15,23,42,.22)" },
  warningIcon: { width: 46, height: 46, display: "grid", placeItems: "center", borderRadius: 16, color: "var(--red-700)", background: "linear-gradient(135deg, var(--red-100), var(--red-200))", fontSize: 21, fontWeight: 900, boxShadow: "inset 0 0 0 1px rgba(185,28,28,.08)" },
  modalTitle: { margin: "0 0 8px", color: "var(--ink)", fontSize: 18, fontWeight: 800 },
  modalText: { margin: 0, color: "#475569", fontSize: 13, lineHeight: 1.55 },
  deleteUserPreview: { display: "flex", alignItems: "center", gap: 10, marginTop: 14, padding: 10, border: "1px solid var(--red-100)", borderRadius: 14, background: "var(--card)", color: "var(--ink)", fontSize: 12 },
  previewAvatar: { width: 34, height: 34, display: "grid", placeItems: "center", borderRadius: 12, color: "var(--card)", background: "linear-gradient(135deg, var(--red-500), #f97316)", fontWeight: 900 },
  previewMeta: { display: "block", marginTop: 2, color: "var(--muted)", fontSize: 11 },
  modalActions: { gridColumn: "1 / -1", display: "flex", justifyContent: "flex-end", gap: 10, paddingTop: 6 },
  confirmDeleteButton: { border: "1px solid var(--red-600)", borderRadius: 10, padding: "10px 14px", color: "var(--card)", background: "linear-gradient(135deg, var(--red-500), var(--red-700))", fontSize: 12.5, fontWeight: 800, cursor: "pointer", fontFamily: "inherit", boxShadow: "0 10px 24px rgba(220, 38, 38, .22)" },
  ...
  editModalCard: { width: "min(780px, 100%)", maxHeight: "calc(100vh - 48px)", overflowY: "auto", display: "flex", flexDirection: "column", gap: 16, padding: 22, border: "1px solid #dbeafe", borderRadius: 22, background: "linear-gradient(180deg, var(--card) 0%, #f8fbff 100%)", boxShadow: "0 28px 80px rgba(15,23,42,.22)" },
  editModalHeader: { display: "flex", alignItems: "flex-start", gap: 14, paddingBottom: 14, borderBottom: "1px solid var(--border)" },
  editModalIcon: { width: 46, height: 46, flex: "0 0 46px", display: "grid", placeItems: "center", borderRadius: 16, color: "var(--primary-dark)", background: "linear-gradient(135deg, #dbeafe, var(--accent-border))", boxShadow: "inset 0 0 0 1px rgba(37,99,235,.08)" },
