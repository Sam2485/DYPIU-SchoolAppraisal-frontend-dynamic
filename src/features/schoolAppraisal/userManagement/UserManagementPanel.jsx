...
const styles = {
  ...
  th: { padding: "10px 11px", borderRight: "1px solid #e2e8f0", color: "#1e293b", background: "#f8fafc", fontSize: 11.5, fontWeight: 700, textAlign: "left" },
  ...
  tableAvatarInitials: { color: "#fff", background: "linear-gradient(135deg, #2563eb, #3b82f6)" },
  ...
  avatarPreviewFallback: { width: 220, height: 220, display: "grid", placeItems: "center", borderRadius: "50%", color: "#fff", background: "linear-gradient(135deg, #2563eb, #3b82f6)", fontSize: 64, fontWeight: 800, boxShadow: "0 0 0 4px #eff6ff" },
